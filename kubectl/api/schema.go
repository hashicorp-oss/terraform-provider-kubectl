...
func getTypeFromSchema(
	elem *openapi3.Schema,
	stackdepth uint64,
	typeCache *sync.Map,
	defs map[string]*openapi3.SchemaRef,
	...
	case elem.Type.Is(openapi3.TypeBoolean):
		return tftypes.Bool, nil

	case elem.Type.Is(openapi3.TypeNumber):
		return tftypes.Number, nil

	case elem.Type.Is(openapi3.TypeInteger):
		return tftypes.Number, nil
	...
	case elem.Type.Is(openapi3.TypeArray):
		switch {
	...
	case elem.Type.Is(openapi3.TypeObject):

		switch {
		case elem.Properties != nil && elem.AdditionalProperties.Has == nil:
